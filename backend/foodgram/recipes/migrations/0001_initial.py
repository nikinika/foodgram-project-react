    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, upload_to="recipes/", verbose_name="Изображение"
                    ),
                ),
                ...
                (
                    "time",
                    models.ImageField(
                        upload_to="", verbose_name="Время приготовления, мин"
                    ),
                ),
                (
                    "pub_date",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("user", "recipe"), name="Неравные списки"
            ),
        ),
        migrations.AddConstraint(
            model_name="ingridrecipe",
            constraint=models.UniqueConstraint(
                fields=("recipe", "ingridients"), name="Неравные ингридиенты"
            ),
        ),
        migrations.AddConstraint(
            model_name="favorite",
